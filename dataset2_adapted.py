...
class ViatalSignDataset_triplet(data.Dataset):
    def __init__(self, mode='train', cl='', model_mel= 0, model_thick=0):
        ...
        mel_feature_path = os.path.join(path, './result/vitalsign_mel_1201_prob_005_input14_2/feature_weight_data')
        thickness_feature_path = os.path.join(path, './result/vitalsign_thickness_1201_prob_005_input14_2/feature_weight_data')

        mel_classify_path = os.path.join(path, './result/vitalsign_mel_1201_prob_005_input14_2/classification_weight_data2')
        thickness_classify_path = os.path.join(path, './result/vitalsign_thickness_1201_prob_005_input14_2/classification_weight_data2')
        ...
        # self.total_label = (self.tb_label * 11) + self.st_label
        # [0908] classification class thb
        #self.total_label = self.tb_label
        # [0908] classification class sto
        #self.total_label = self.st_label
...
class ViatalSignDataset_triplet_mel_thickness(data.Dataset):
    def __init__(self, mode='train', cl='', model_mel= 0, model_thick=0):
        ...
        self.total_label = torch.LongTensor(m_label).to('cuda')
    ...
    def __getitem__(self, index):
        ...
        #return anchor, positive, negative, mel_positive, mel_negative, thb_positive, thb_negative, sto_positive, sto_negative, thickness_positive, thickness_negative, ml, tbl, stl, thl, totall
        return anchor, ml, tbl, stl, thl, totall
    ...
    def read_vitalsign_dataset(self, name, model_mel, model_thick):
        ...
        #                 'input_data_random10.npy', 'input_data_random11.npy', 'input_data_random12.npy','input_data_random14.npy', 'input_data_random15.npy']

        fileNameList = ['input_data13.npy', 'input_data_random20.npy']
        test_fileNameList = ['input_data13.npy', 'input_data_random20.npy']
...
class ViatalSignDataset_class(data.Dataset):
    def __init__(self, mode='train', cl='', use_gpu = False, model_mel= -1, model_thick=-1):
        ...
        if mode == "train":
            reflect_list, m_label, tb_label, tb_label3, st_label, st_label3, th_label, comb_label = self.read_vitalsign_dataset(name='train', model_mel=model_mel, model_thick=model_thick)
        else:
            reflect_list, m_label, tb_label, tb_label3, st_label, st_label3, th_label, comb_label = self.read_vitalsign_dataset(name='test', model_mel=model_mel, model_thick=model_thick)
    ...
    def read_vitalsign_dataset(self, name, model_mel, model_thick):
        ...
        return reflect_list, m_label, tb_label, tb_label3, st_label,  st_label3, th_label, combination_label3
